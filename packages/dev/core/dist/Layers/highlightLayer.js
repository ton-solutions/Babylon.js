...
export class HighlightLayer extends EffectLayer {
    ...
    constructor(name, scene, options) {
        ...
        // Adapt options
        this._options = Object.assign({ mainTextureRatio: 0.5, blurTextureSizeRatio: 0.5, blurHorizontalSize: 1.0, blurVerticalSize: 1.0, alphaBlendingMode: Constants.ALPHA_COMBINE, camera: null, renderingGroupId: -1 }, options);
