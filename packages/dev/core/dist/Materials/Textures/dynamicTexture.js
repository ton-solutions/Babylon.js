...
export class DynamicTexture extends Texture {
     ...
     */
    constructor(name, options, scene = null, generateMipMaps = false, samplingMode = Constants.TEXTURE_TRILINEAR_SAMPLINGMODE, format = Constants.TEXTUREFORMAT_RGBA, invertY) {
