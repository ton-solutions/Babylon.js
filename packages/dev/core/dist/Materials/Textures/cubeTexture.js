...
export class CubeTexture extends BaseTexture {
     ...
     */
    constructor(rootUrl, sceneOrEngine, extensions = null, noMipmap = false, files = null, onLoad = null, onError = null, format = Constants.TEXTUREFORMAT_RGBA, prefiltered = false, forcedExtension = null, createPolynomials = false, lodScale = 0.8, lodOffset = 0, loaderOptions, useSRGBBuffer) {
        var _a;
        super(sceneOrEngine);
        this._lodScale = 0.8;
        this._lodOffset = 0;
    ...
    setReflectionTextureMatrix(value) {
        ...
        if (value.isIdentity() !== this._textureMatrix.isIdentity()) {
            (_a = this.getScene()) === null || _a === void 0 ? void 0 : _a.markAllMaterialsAsDirty(Constants.MATERIAL_TextureDirtyFlag, (mat) => mat.getActiveTextures().indexOf(this) !== -1);
        }
    ...
    _loadTexture(onLoad = null, onError = null) {
        ...
        const onLoadProcessing = () => {
            ...
            if (oldTexture) {
                oldTexture.dispose();
                (_a = this.getScene()) === null || _a === void 0 ? void 0 : _a.markAllMaterialsAsDirty(Constants.MATERIAL_TextureDirtyFlag);
            }
            if (onLoad) {
                onLoad();
            }
