...
export class HandConstraintBehavior {
    ...
    _getHandPose() {
        ...
        if (hand) {
            const pinkyMetacarpal = hand.getJointMesh("pinky-finger-metacarpal" /* PINKY_FINGER_METACARPAL */);
            const middleMetacarpal = hand.getJointMesh("middle-finger-metacarpal" /* MIDDLE_FINGER_METACARPAL */);
            const wrist = hand.getJointMesh("wrist" /* WRIST */);
