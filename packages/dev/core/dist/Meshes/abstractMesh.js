...
export class AbstractMesh extends TransformNode {
    ...
    _collideForSubMesh(subMesh, transformMatrix, collider) {
        ...
        // Collide
        collider._collide(subMesh._trianglePlanes, subMesh._lastColliderWorldVertices, this.getIndices(), subMesh.indexStart, subMesh.indexStart + subMesh.indexCount, subMesh.verticesStart, !!subMesh.getMaterial(), this, this._shouldConvertRHS(), ((_a = subMesh.getMaterial()) === null || _a === void 0 ? void 0 : _a.fillMode) === Constants.MATERIAL_TriangleStripDrawMode);
        return this;
    }
    /**
     * @param collider
