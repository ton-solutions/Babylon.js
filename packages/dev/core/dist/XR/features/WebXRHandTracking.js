...
const handPartsDefinition = {
    ...
    ["thumb" /* THUMB */]: ["thumb-metacarpal" /* THUMB_METACARPAL */, "thumb-phalanx-proximal" /* THUMB_PHALANX_PROXIMAL */, "thumb-phalanx-distal" /* THUMB_PHALANX_DISTAL */, "thumb-tip" /* THUMB_TIP */],
    ["index" /* INDEX */]: [
        "index-finger-metacarpal" /* INDEX_FINGER_METACARPAL */,
        "index-finger-phalanx-proximal" /* INDEX_FINGER_PHALANX_PROXIMAL */,
        "index-finger-phalanx-intermediate" /* INDEX_FINGER_PHALANX_INTERMEDIATE */,
...
export class WebXRHandTracking extends WebXRAbstractFeature {
    ...
    static _GenerateDefaultHandMeshRigMapping(handedness) {
        ...
        return {
            ["wrist" /* WRIST */]: `wrist_${H}`,
            ["thumb-metacarpal" /* THUMB_METACARPAL */]: `thumb_metacarpal_${H}`,
            ["thumb-phalanx-proximal" /* THUMB_PHALANX_PROXIMAL */]: `thumb_proxPhalanx_${H}`,
            ["thumb-phalanx-distal" /* THUMB_PHALANX_DISTAL */]: `thumb_distPhalanx_${H}`,
            ["thumb-tip" /* THUMB_TIP */]: `thumb_tip_${H}`,
            ["index-finger-metacarpal" /* INDEX_FINGER_METACARPAL */]: `index_metacarpal_${H}`,
            ["index-finger-phalanx-proximal" /* INDEX_FINGER_PHALANX_PROXIMAL */]: `index_proxPhalanx_${H}`,
            ["index-finger-phalanx-intermediate" /* INDEX_FINGER_PHALANX_INTERMEDIATE */]: `index_intPhalanx_${H}`,
            ["index-finger-phalanx-distal" /* INDEX_FINGER_PHALANX_DISTAL */]: `index_distPhalanx_${H}`,
            ["index-finger-tip" /* INDEX_FINGER_TIP */]: `index_tip_${H}`,
            ["middle-finger-metacarpal" /* MIDDLE_FINGER_METACARPAL */]: `middle_metacarpal_${H}`,
            ["middle-finger-phalanx-proximal" /* MIDDLE_FINGER_PHALANX_PROXIMAL */]: `middle_proxPhalanx_${H}`,
            ["middle-finger-phalanx-intermediate" /* MIDDLE_FINGER_PHALANX_INTERMEDIATE */]: `middle_intPhalanx_${H}`,
            ["middle-finger-phalanx-distal" /* MIDDLE_FINGER_PHALANX_DISTAL */]: `middle_distPhalanx_${H}`,
            ["middle-finger-tip" /* MIDDLE_FINGER_TIP */]: `middle_tip_${H}`,
            ["ring-finger-metacarpal" /* RING_FINGER_METACARPAL */]: `ring_metacarpal_${H}`,
            ["ring-finger-phalanx-proximal" /* RING_FINGER_PHALANX_PROXIMAL */]: `ring_proxPhalanx_${H}`,
            ["ring-finger-phalanx-intermediate" /* RING_FINGER_PHALANX_INTERMEDIATE */]: `ring_intPhalanx_${H}`,
            ["ring-finger-phalanx-distal" /* RING_FINGER_PHALANX_DISTAL */]: `ring_distPhalanx_${H}`,
            ["ring-finger-tip" /* RING_FINGER_TIP */]: `ring_tip_${H}`,
            ["pinky-finger-metacarpal" /* PINKY_FINGER_METACARPAL */]: `little_metacarpal_${H}`,
            ["pinky-finger-phalanx-proximal" /* PINKY_FINGER_PHALANX_PROXIMAL */]: `little_proxPhalanx_${H}`,
            ["pinky-finger-phalanx-intermediate" /* PINKY_FINGER_PHALANX_INTERMEDIATE */]: `little_intPhalanx_${H}`,
            ["pinky-finger-phalanx-distal" /* PINKY_FINGER_PHALANX_DISTAL */]: `little_distPhalanx_${H}`,
            ["pinky-finger-tip" /* PINKY_FINGER_TIP */]: `little_tip_${H}`,
        };
    }
    /**
