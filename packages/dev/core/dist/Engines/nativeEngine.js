...
export class NativeEngine extends Engine {
    ...
    _recordVertexArrayObject(vertexArray, vertexBuffers, indexBuffer, effect) {
        if (indexBuffer) {
    ...
    updateRawTexture(texture, bufferView, format, invertY, compression = null, type = Constants.TEXTURETYPE_UNSIGNED_INT) {
        if (!texture) {
            return;
        }
