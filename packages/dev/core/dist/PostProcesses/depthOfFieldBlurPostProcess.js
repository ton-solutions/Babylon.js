...
export class DepthOfFieldBlurPostProcess extends BlurPostProcess {
     ...
     */
    constructor(name, scene, direction, kernel, options, camera, circleOfConfusion, imageToBlur = null, samplingMode = Texture.BILINEAR_SAMPLINGMODE, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_INT, blockCompilation = false) {
        super(name, direction, kernel, options, camera, 
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        (samplingMode = Constants.TEXTURE_BILINEAR_SAMPLINGMODE), engine, reusable, 
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        (textureType = Constants.TEXTURETYPE_UNSIGNED_INT), `#define DOF 1\r\n`, blockCompilation);
